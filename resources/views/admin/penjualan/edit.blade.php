                            ...
                            <form action="{{ url('admin/penjualan', $penjualan->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" id="stok_terjual" name="stok_terjual" class="form-control" placeholder="Masukan Stok Terjual" value="{{ $penjualan->stok_penjualan }}">
                                        @error('stok_terjual')
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" id="summernote" cols="30" rows="7" placeholder="Masukan Deskripsi Penjualan">{{ $penjualan->deskripsi }}</textarea>
                                        @error('deskripsi')
                                        <p class="text-danger" style="font-size: 12px">* {{ $message }}</p>
                                        @enderror
                                    </div>
