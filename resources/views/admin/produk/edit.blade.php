                            ...
                            <form action="{{ url('admin/produk', $produk->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="berat_produk" class="form-control">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="number" id="name" name="stok_produk" class="form-control" value="{{ $produk->stok_produk }}" placeholder="Masukan Stok Produk">
                                        @error('stok_produk')
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="file" id="name" name="gambar_produk" class="form-control" placeholder="Masukan Gambar Produk">
                                        @error('gambar_produk')
                                        <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                        @enderror
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" id="summernote" cols="30" rows="7" placeholder="Masukan Deskripsi Produk">{{ $produk->deskripsi }}</textarea>
                                        @error('deskripsi')
                                        <p class="text-danger" style="font-size: 12px">* {{ $message }}</p style="font-size: 12px">
                                        @enderror
                                    </div>
